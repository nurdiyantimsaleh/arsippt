		...
		<div id="content">
			<div id="page">Laporan Berkas Perkara</div>
		</div>
		
		<div id="content">
			<div id="view-table">
				 <br>
				 <form action="index.php?page=laporanperkara" method="post" >
            ...
            <div id="content">
              ...
              <table id="table" >
				...
				inner join tbl_perkara on tbl_arsipperkara.id_perkara = tbl_perkara.id_perkara) where tanggal between '$awal' and '$akhir'";
