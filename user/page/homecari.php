		...
		<div id="content">
			<div id="view-table-top">
				<a href="index.php?page=perkaratambah" class="aadd"><i class="fa-plus-square"></i> Tambah Data </a><br>
				<br>
				<form name="formcari" method="post" action="index.php?page=homecari">
				<input class="cari-data" type="text" name="cari" placeholder="Search.." style=""> <input class="btn-cari-data" type="submit" value="Search" > </td>
				</form>
				<br>
				<table id="table">
				  <tr>
				...
				inner join tbl_perkara on tbl_arsipperkara.id_perkara = tbl_perkara.id_perkara where no_pn like '%$cari%'";
